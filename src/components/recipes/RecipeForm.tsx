...
function defaultFormData(): RecipeFormData {
  return {
    ...
    steps: [
      { id: crypto.randomUUID(), type: "AUTOLYSE", label: "Autolyse", description: "Combine flour and water, rest.", durationMins: 30, tempF: null, sortOrder: 0 },
      { id: crypto.randomUUID(), type: "MIX", label: "Mix in Starter & Salt", description: "Add levain and salt, incorporate fully.", durationMins: 10, tempF: null, sortOrder: 1 },
      { id: crypto.randomUUID(), type: "BULK_FERMENT", label: "Bulk Fermentation", description: "Ferment at room temperature with stretch and folds.", durationMins: 240, tempF: 75, sortOrder: 2 },
      { id: crypto.randomUUID(), type: "FOLD", label: "Stretch & Fold (x4)", description: "Perform 4 sets of stretch and folds every 30 minutes.", durationMins: 30, tempF: null, sortOrder: 3 },
      { id: crypto.randomUUID(), type: "PRESHAPE", label: "Preshape", description: "Gently preshape the dough.", durationMins: 5, tempF: null, sortOrder: 4 },
      { id: crypto.randomUUID(), type: "BENCH_REST", label: "Bench Rest", description: "Rest uncovered on the bench.", durationMins: 30, tempF: null, sortOrder: 5 },
      { id: crypto.randomUUID(), type: "SHAPE", label: "Final Shape", description: "Shape into a batard or boule.", durationMins: 10, tempF: null, sortOrder: 6 },
      { id: crypto.randomUUID(), type: "PROOF", label: "Proof", description: "Place in a floured banneton.", durationMins: 60, tempF: 75, sortOrder: 7 },
      { id: crypto.randomUUID(), type: "COLD_PROOF", label: "Cold Proof", description: "Overnight in the fridge.", durationMins: 720, tempF: 39, sortOrder: 8 },
      { id: crypto.randomUUID(), type: "BAKE", label: "Bake", description: "Score and bake in a Dutch oven.", durationMins: 45, tempF: 500, sortOrder: 9 },
      { id: crypto.randomUUID(), type: "COOL", label: "Cool", description: "Cool on a wire rack before slicing.", durationMins: 60, tempF: null, sortOrder: 10 },
    ],
  };
}
